...
{
    protected $link = 'master/medicine/';
    protected $perms = 'master-medicine';
    ...
    function __construct()
    {
        ...
        $this->setBreadcrumb(['Master' => '#', 'Medicine' => '#']);
    ...
    {
        $records = Medicine::with('creator')->select('*');
        //Init Sort
    ...
    {
        return $this->render('modules.master.medicine.index', ['mockup' => false]);
    }

    public function create()
    {
        return $this->render('modules.master.medicine.create');
    }
    ...
    public function edit($id)
    {
        ...
        return $this->render('modules.master.medicine.edit', [
            'record' => $record
        ]);
    }
