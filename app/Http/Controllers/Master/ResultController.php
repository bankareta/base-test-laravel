...
/* Validation */
use App\Http\Requests\Master\ResultRequest;
...
{
    protected $link = 'master/result/';
    protected $perms = 'master-result';
    ...
    function __construct()
    {
        ...
        $this->setBreadcrumb(['Master' => '#', 'Result' => '#']);
    ...
    {
        $records = Result::with('creator')->select('*');
        //Init Sort
    ...
    {
        return $this->render('modules.master.result.index', ['mockup' => false]);
    }

    public function create()
    {
        return $this->render('modules.master.result.create');
    }

    public function store(ResultRequest $request)
    {
        try {
            $record = Result::saveData($request);
    ...
    public function edit($id)
    {
        ...
        return $this->render('modules.master.result.edit', [
            'record' => $record
        ]);
    }
