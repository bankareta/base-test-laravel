...
{
    protected $link = 'master/division/';
    protected $perms = 'master-division';
    ...
    function __construct()
    {
        ...
        $this->setBreadcrumb(['Master' => '#', 'Division' => '#']);
    ...
    {
        $records = Division::with('creator')->select('*');
        //Init Sort
    ...
    {
        return $this->render('modules.master.division.index', ['mockup' => false]);
    }

    public function create()
    {
        return $this->render('modules.master.division.create');
    }

    public function store(DivisionRequest $request)
    {
        try {
            $record = Division::saveData($request);
    ...
    public function edit($id)
    {
        ...
        return $this->render('modules.master.division.edit', [
            'record' => $record
        ]);
    }
