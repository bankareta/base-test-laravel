...
/* Validation */
use App\Http\Requests\Master\PobReasonRequest;
...
{
    protected $link = 'master/pob-reason/';
    protected $perms = 'pob-reason';

    function __construct()
    {
        $this->setLink($this->link);
        $this->setPerms($this->perms);
        $this->setTitle("POB Reason");
        $this->setModalSize("mini");
        $this->setBreadcrumb(['Master' => '#', 'POB Reason' => '#']);
    ...
    {
        $records = PobReason::with('creator')->select('*');
        //Init Sort
    ...
    {
        return $this->render('modules.master.pob-reason.index', ['mockup' => false]);
    }

    public function create()
    {
        return $this->render('modules.master.pob-reason.create');
    }

    public function store(PobReasonRequest $request)
    {
        try {
            $record = PobReason::saveData($request);
    ...
    {
        $record = PobReason::find($id);

        return $this->render('modules.master.pob-reason.edit', [
            'record' => $record
        ]);
    }


    public function update(PobReasonRequest $request, $id)
    {
         try {
            $record = PobReason::saveData($request);
