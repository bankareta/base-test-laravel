...
/* Validation */
use App\Http\Requests\Master\ComponentRequest;

/* Models */
use App\Models\Master\Component;
...
{
    protected $link = 'master/component/';
    protected $perms = 'master-component';
    ...
    function __construct()
    {
        ...
        $this->setBreadcrumb(['Master' => '#', 'Component' => '#']);
    ...
    {
        $records = Component::with('creator')->select('*');
        //Init Sort
        ...
        if ($name = $request->name) {
            $records->where('component', 'like', '%' . $name . '%');
        }
    ...
    {
        return $this->render('modules.master.component.index', ['mockup' => false]);
    }

    public function create()
    {
        return $this->render('modules.master.component.create');
    }

    public function store(ComponentRequest $request)
    {
        try {
            $record = Component::saveData($request);
    ...
    {
        $record = Component::find($id);

        return $this->render('modules.master.component.edit', [
            'record' => $record
        ]);
    }
