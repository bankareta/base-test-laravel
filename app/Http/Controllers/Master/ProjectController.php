...
{
    protected $link = 'master/project/';
    protected $perms = 'master-project';
    ...
    {
        $records = Project::with('creator')->select('*');
        //Init Sort
        ...
        //Filters
        if ($type_project = $request->type_project) {
            $records->where('type_project', $type_project);
        }

        if ($name = $request->name) {
            $records->where('project', 'like', '%' . $name . '%');
        }
    ...
    {
        return $this->render('modules.master.project.index', ['mockup' => false]);
    }
    ...
    {
        try {
            $record = Project::saveData($request);
    ...
    public function edit($id)
    {
        ...
        return $this->render('modules.master.project.edit', [
            'record' => $record
        ]);
    }
