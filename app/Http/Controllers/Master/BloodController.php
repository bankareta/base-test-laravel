...
/* Validation */
use App\Http\Requests\Master\BloodRequest;
...
{
    protected $link = 'master/blood/';
    protected $perms = 'master-blood';
    ...
    function __construct()
    {
        ...
        $this->setBreadcrumb(['Master' => '#', 'Blood' => '#']);
    ...
    {
        $records = Blood::with('creator')->select('*');
        //Init Sort
    ...
    {
        return $this->render('modules.master.blood.index', ['mockup' => false]);
    }

    public function create()
    {
        return $this->render('modules.master.blood.create');
    }

    public function store(BloodRequest $request)
    {
        try {
            $record = Blood::saveData($request);
    ...
    {
        $record = Blood::find($id);

        return $this->render('modules.master.blood.edit', [
            'record' => $record
        ]);
    }
