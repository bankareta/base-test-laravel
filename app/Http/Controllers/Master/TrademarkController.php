...
/* Validation */
use App\Http\Requests\Master\TrademarkRequest;
...
{
    protected $link = 'master/trademark/';
    protected $perms = 'master-trademark';

    function __construct()
    {
        $this->setLink($this->link);
        $this->setPerms($this->perms);
        $this->setTitle("Trademark");
        $this->setModalSize("mini");
        $this->setBreadcrumb(['Master' => '#', 'Trademark' => '#']);
    ...
    {
        $records = Trademark::with('creator')->select('*');
        //Init Sort
    ...
    {
        return $this->render('modules.master.trademark.index', ['mockup' => false]);
    }

    public function create()
    {
        return $this->render('modules.master.trademark.create');
    }

    public function store(TrademarkRequest $request)
    {
        try {
            $record = Trademark::saveData($request);
    ...
    {
        $record = Trademark::find($id);

        return $this->render('modules.master.trademark.edit', [
            'record' => $record
        ]);
    }
