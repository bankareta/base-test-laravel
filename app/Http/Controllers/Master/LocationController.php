...
{
    protected $link = 'master/location/';
    protected $perms = 'master-location';
    ...
    function __construct()
    {
        ...
        $this->setBreadcrumb(['Master' => '#', 'Location' => '#']);
    ...
    {
        $records = Location::with('site','creator')->select('*');
        //Init Sort
    ...
    {
        return $this->render('modules.master.location.index', ['mockup' => false]);
    }

    public function create()
    {
        return $this->render('modules.master.location.create');
    }

    public function store(LocationRequest $request)
    {
        try {
            $record = Location::saveData($request);
    ...
    public function edit($id)
    {
        ...
        return $this->render('modules.master.location.edit', [
            'record' => $record
        ]);
    }
