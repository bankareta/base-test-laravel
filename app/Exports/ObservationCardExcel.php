...
class ObservationCardExcel implements FromView, WithStyles, WithColumnWidths, WithDrawings
{
    private $query;
    ...
    public function styles(Worksheet $sheet)
    {
        ...
        $styles = [
            ...
            'C:L' => $this->generateStyles(['vertical-top']),
            'A7:L'.$total_line => $this->generateStyles(['centered']),

            'B8:L' . $total_line => $this->generateStyles(['all-border']),

            'D2:F2' => $this->generateStyles(['centered', 'font-lg']),
            'B6:L8' => $this->generateStyles(['all-border', 'centered']),
        ];
    ...
    {
        return view('export.excel-obs', $this->query);
    }
