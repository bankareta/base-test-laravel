            ...
            */
            ...
            'settings' => [
                ...
                */
                ...
                'account_suffix' => env('LDAP_ACCOUNT_SUFFIX', '@supreme-energy.local'),
                ...
                */
                ...
                // 'hosts' => explode('10.1.1.8', env('LDAP_HOSTS', 'corp-dc1.corp.acme.org corp-dc2.corp.acme.org')),
                'hosts' => ['10.1.1.8'],
                ...
                */
                ...
                'base_dn' => env('LDAP_BASE_DN', 'dc=supreme-energy,dc=local'),
                ...
                */
                ...
                'username' => env('LDAP_USERNAME','printer'),
                'password' => env('LDAP_PASSWORD','printer'),
