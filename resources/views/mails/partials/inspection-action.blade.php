...
<div class="row mt-5 pt-5">
		...
		<div class="rdg-expertise-category"><span>Actual :</span></div><br>
			<p style="font-size: 11px" class="font-color">
				{!! $record->detail->actual or '' !!}
			</p>
			
</div><br>
<div class="row mt-5 pt-5">
	
		<div class="rdg-expertise-category"><span>Remark :</span></div><br>
			<p style="font-size: 11px" class="font-color">
				{!! $record->detail->remark or '' !!}
			</p>
</div>
