...
<script type="text/javascript">
    ...
    $(document).on('input', 'input[name="phone"]', function(e){
        var x = `<div class="ui basic red pointing prompt label transition visible">Character length must be right </div>`;
        var d = `<div class="ui basic red pointing prompt label transition visible"> Must be a number</div>`;
        if ($.isNumeric(this.value))
        {
    ...
    $('.table.fasilitas').on('click', '.modal-add', function(event) {
        ...
        $('.table.fasilitas').append("<tr>" +
          "<td class='collapsing'><button type='button' data-content='Delete Data' class='ui mini red icon modal-delete button'><i class='trash icon'></i></button></td>" +
