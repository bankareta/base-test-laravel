...
@section('filters')
<div class="field">
	<div class="ui input left icon" style="width: 200px">
		<select id="type_id" name="filter[type_project]" class="ui fluid search dropdown" >
            {!! App\Models\Master\TypeProject::options('name','id',[], 'Choose One') !!}
        </select>
	</div>
	<div class="ui input left icon">
		<i class="search icon"></i>
		<input type="text" name="filter[name]"  placeholder="Project Name" >
	</div>
</div>
...
d.type_project = $("select[name='filter[type_project]']").val();
@endsection
