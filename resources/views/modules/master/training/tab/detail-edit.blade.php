<div class="field">
    ...
    <input type="text" name="title" placeholder="Training Title" value="{{ $record->title or '' }}">
</div>
<div class="field">
  <label>Type Training</label>
  <select name="type_training_id" class="ui search selection dropdown">
    {!! \App\Models\Master\TypeTraining::options('name', 'id', ['selected' => $record->type_training_id], 'Choose Training Type') !!}
  </select>
</div>
<div class="field">
