			...
			<table class="ui celled structured table">
				<tbody>
					...
					<tr>
						<td colspan="4">
							<div class="field">
								<textarea name="question" class="transparent" readonly>{!! $record->question !!}</textarea>
							</div>
						</td>
					</tr>
					<tr class="active">
						...
						<td class="right aligned">
							<div class="field" style="width: 250px;">
								<input type="text" value="{{ $record->type_answer == 0 ? 'Multiple Choice' : 'True / False' }}" readonly name="" id="">
							</div>
						</td>
					</tr>
									...
									<tr>
										<td class="one wide">
											<div class="ui radio checkbox">
												<input type="radio" onclick="return false;" name="true" value="1" {{ $record->showTrue(1) == 1 ? 'checked' : '' }}>
												<label>A</label>
											</div>
										</td>
										<td>
											<div class="field">
												<textarea readonly name="answer[{{ $record->showId(1) }}]" class="transparent"> {!! $record->showAnswer(1) !!}</textarea>
											</div>
										</td>
										<td class="one wide">
											<div class="ui radio checkbox">
												<input type="radio" onclick="return false;" name="true" value="2" {{ $record->showTrue(2) == 1 ? 'checked' : '' }}>
												<label>B</label>
											</div>
										</td>
										<td>
											<div class="field">
												<textarea readonly name="answer[{{ $record->showId(2) }}]" class="transparent">{!! $record->showAnswer(2) !!}</textarea>
											</div>
										</td>
									</tr>
									<tr>
										<td class="one wide">
											<div class="ui radio checkbox">
												<input type="radio" onclick="return false;" name="true" value="3" {{ $record->showTrue(3) == 1 ? 'checked' : '' }}>
												<label>C</label>
											</div>
										</td>
										<td>
											<div class="field">
												<textarea readonly name="answer[{{ $record->showId(3) }}]" class="transparent">{!! $record->showAnswer(3) !!}</textarea>
											</div>
										</td>
										<td class="one wide">
											<div class="ui radio checkbox">
												<input type="radio" onclick="return false;" name="true" value="4" {{ $record->showTrue(4) == 1 ? 'checked' : '' }}>
												<label>D</label>
											</div>
										</td>
										<td>
											<div class="field">
												<textarea readonly name="answer[{{ $record->showId(4) }}]" class="transparent">{!! $record->showAnswer(3) !!}</textarea>
											</div>
										</td>
									</tr>
								</table>
