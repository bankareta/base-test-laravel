...
<div class="field">
		<div class="ui input left icon">
			...
			<input type="text" name="filter[name]"  placeholder="Contractor's Name" value="">
		</div>
		<div class="ui input left icon">
			<i class="search icon"></i>
			<input type="text" name="filter[reference]"  placeholder="Contract Reference No" value="">
		</div>
</div>
...
d.reference = $("input[name='filter[reference]']").val();
