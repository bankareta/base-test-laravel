...
<script type="text/javascript">
	...
	$(document).ready(function () {
	    ...
	    $('.ui.tabular .item[data-tab="'+ tab +'"]').trigger('click');
			...
			$('select[name="site_id"]').parents('.ui.dropdown:first').dropdown({
					onChange: function (value) {
							showuserurl = '{{ url($pageUrl.'show-users') }}/0/' + value;
...
<form class="ui data form" id="dataForm" action="{{ url($pageUrl) }}/save-participant" method="POST">
	{!! csrf_field() !!}
