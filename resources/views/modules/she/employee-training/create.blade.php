    ...
    <div class="ui segment">
      <div class="three fields">
        ...
        <div class="field">
          ...
          <select class="ui fluid search dropdown" name="type_id">
            {!! App\Models\Master\TypeTraining::options('name','id',[], 'Choose One') !!}
          </select>
        </div>
        <div class="field">
          <label>Certificate Number</label>
          <input type="text" name="number" placeholder="Certificate Number">
        </div>
      </div>
      <div class="three fields">
        <div class="field">
          <label>Title Training</label>
          <input type="text" name="title" placeholder="Title Training">
        </div>
        <div class="field">
      ...
      <div class="three fields">
        <div class="field maxdate">
          ...
          <input type="text" name="training_date" placeholder="Date of Training " readonly="">
        </div>
        <div class="field date">
          <label>Expired Date</label>
          <input type="text" name="expire_date" placeholder="Expired Date" readonly="">
        </div>
        <div class="field">
          <label>Issued by</label>
          <select id="employee" name="issued_by" class="ui fluid search dropdown">
            {!! App\Models\Master\InstitutionTraining::options('name','id',[], 'Choose One') !!}
          </select>
        </div>
      </div>
