    ...
    <div class="ui segment">
      <div class="three fields">
        ...
        <div class="field">
          ...
          <select id="location" name="location" class="ui class dropdown">
              {!! App\Models\Master\Location::options('name','id',['filters' => [
                function ($site) use ($record) {
                    $site->where('site_id', $record->site_id);
                  },
                ],
        ...
        <div class="field">
          ...
          <input type="text" name="location_detail" value="{{ $record->location_detail or '' }}" placeholder="Location Details">
        </div>
      </div>
      ...
      <div class="three fields">
        <div class="field">
          ...
          <input type="text" name="company" value="{{ $record->company or '' }}" placeholder="Observed Company">
        </div>
        <div class="field">
          ...
          <select id="departObserver" name="obs_department_id" class="ui class dropdown">
            {!! App\Models\Master\Departemen::options('name','id',[
              'selected' => $record->obs_department_id,
              'filters' => [
              function ($site)use($record) {
                  $site->where('site_id', $record->site_id);
                },
        ...
        <div class="field">
          ...
          <input type="text" name="observer_name" value="{{ $record->observer_name or '' }}" placeholder="Observer's Name">
        </div>
      </div>
